...
import { channelList, playersfudido, updateUserPacks, usersList } from './database/dbQuerys'
...
client.on('messageCreate', async (message: Message) => {
    ...
    if(message.author.id === '520994132458471438' && message.content === 'sexo5') {
        console.log(await playersfudido())
    }
