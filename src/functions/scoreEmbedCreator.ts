...
export default async function scoreEmbedCreator(score: Interfaces.ScoreInterface): Promise<EmbedBuilder> {
    ...
    const embed = new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: 'Acc:', value: `${scores[0].acc}%`, inline: true },
            ...
            { name: 'Beatmap Info:', value: `${scores[0].beatmap.total_length} - CS: ${scores[0].beatmap.cs} AR: ${scores[0].beatmap.ar} OD: ${scores[0].beatmap.od} HP: ${scores[0].beatmap.hp}` }
        )
